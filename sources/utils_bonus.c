...
/*   Updated: 2022/01/27 19:11:00 by ajazbuti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lose_game(t_game *gm, int a, int b)
{
	...
	mlx_put_image_to_window(gm->mlx, gm->win, gm->img[tile].i,
		gm->e.x * M, gm->e.y * M);
	mlx_put_image_to_window(gm->mlx, gm->win, gm->img[boom].i,
		a * M, b * M);
	mlx_put_image_to_window(gm->mlx, gm->win, gm->img[lose].i, x, y);
	printf("You're NOT victorious!!\n");
}	
